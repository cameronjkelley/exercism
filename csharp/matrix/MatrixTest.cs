...
public class MatrixTest
{
    ...
    [TestCase("4 7", ExpectedResult = new[] { 4, 7 })]
    [TestCase("1 2\n10 20", ExpectedResult = new[] { 1, 2 })]
    [TestCase("9 7 6\n8 6 5\n5 3 2", ExpectedResult = new[] { 9, 7, 6 })]
    ...
    [TestCase("5", ExpectedResult = new[] { 5 })]
    [TestCase("9 7", ExpectedResult = new[] { 9, 7 })]
    [TestCase("9 8 7\n19 18 17", ExpectedResult = new[] { 19, 18, 17 })]
    [TestCase("1 4 9\n16 25 36\n5 6 7", ExpectedResult = new[] { 5, 6, 7 })]
    ...
    [TestCase("55 44", ExpectedResult = new[] { 55 })]
    [TestCase("89 1903\n18 3", ExpectedResult = new[] { 89, 18 })]
    [TestCase("1 2 3\n4 5 6\n7 8 9\n8 7 6", ExpectedResult = new[] { 1, 4, 7, 8 })]
    ...
    [TestCase("28", ExpectedResult = new[] { 28 })]
    [TestCase("13\n16\n19", ExpectedResult = new[] { 13, 16, 19 })]
    [TestCase("289 21903 23\n218 23 21", ExpectedResult = new[] { 23, 21 })]
    [TestCase("11 12 13\n14 15 16\n17 18 19\n18 17 16", ExpectedResult = new[] { 13, 16, 19, 16 })]
